...
- [x] 17. Create test generators and integration tests
  ...
  - [x] 17.2 Write integration tests for ingestion flow
    - Test connect source → receive data → normalize → validate → store
    - _Requirements: 2.2, 3.2, 4.2, 5.2_
  - [x] 17.3 Write integration tests for snapshot assembly
